...
function ENT:OnSpawn( PObj )
	...
	-- example:
	--local WheelModel = "models/props_vehicles/jeep01_tire.mdl"

	--local WheelFrontLeft = self:AddWheel( { pos = Vector(69,37.5,-25), mdl = WheelModel, mdl_ang = Angle(0,90,0) } )
	--local WheelFrontRight = self:AddWheel( { pos = Vector(69,-37.5,-25), mdl = WheelModel, mdl_ang = Angle(0,-90,0) } )

	--local WheelRearLeft = self:AddWheel( {pos = Vector(-51,37.5,-25), mdl = WheelModel, mdl_ang = Angle(0,90,0)} )
	--local WheelRearRight = self:AddWheel( {pos = Vector(-51,-37.5,-25), mdl = WheelModel, mdl_ang = Angle(0,-90,0)} )
	...
	local RearAxle = self:DefineAxle( {
		...
		Suspension = RWSuspensionSettings,
	} )]]
